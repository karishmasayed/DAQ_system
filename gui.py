...
class MyWindow:
    def __init__(self, root, fthandle):
        ...
        # Initialize StringVar variables for labels
        self.reg1 = tk.StringVar()
        self.reg2 = tk.StringVar()
        self.reg3 = tk.StringVar()
        self.reg4 = tk.StringVar()
        self.reg5 = tk.StringVar()
        self.reg6 = tk.StringVar()
        self.reg7 =  tk.StringVar()
        self.reg8 =  tk.StringVar()
        self.reg9 =  tk.StringVar()
        self.reg10 =  tk.StringVar()
    ...
    def recievedata(self):
        ...
        try:
                ...
                extracted_substrings = []  # Initialize a list to store extracted substrings
                while index != -1:  # If the pattern is found
                    ...
                    if subindex != -1:  # If the subpattern is found
                        ...
                        extracted_substrings.append(subextracted_data)  # Append the extracted substring to the list
                ...
                # Print the extracted substrings and their corresponding variable names
                for i, substring in enumerate(extracted_substrings):
                    var_name = f"substring_{i+1}"
                    globals()[var_name] = substring  # Create variables dynamically
                    print(f"{var_name}: {substring}")
                    
                    self.reg1.set(substring[:6])
                    self.reg2.set(substring[6:8])
                    self.reg3.set(substring[8:14])
                    self.reg4.set(substring[14:20])
                    self.reg5.set(substring[20:26])
                    self.reg6.set(substring[26:32])
                    self.reg7.set(substring[32:38])
                    self.reg8.set(substring[38:44])
                    self.reg9.set(substring[44:50])
                    self.reg10.set(substring[50:56])

                    if (self.reg3.get() == "000000") :
                        x1 = 0
                    else :
                        x1 = 1   

                    if self.reg4.get() == "000000" :
                        x2 = 0
                    else :
                        x2 = 1  

                    if self.reg5.get() == "000000" :
                        x3 = 0
                    else :
                        x3 = 1       
                    
                    if self.reg6.get() == "000000" :
                        x4 = 0
                    else :
                        x4 = 1  

                    if self.reg7.get() == "000000" :
                        x5 = 0
                    else :
                        x5 = 1  

                    if self.reg8.get() == "000000" :
                        x6 = 0
                    else :
                        x6 = 1  

                    if self.reg9.get() == "000000" :
                        x7 = 0
                    else :
                        x7 = 1  

                    if self.reg10.get() == "000000" :
                        x8 = 0
                    else :
                        x8 = 1    


                    print("self.reg1: ",self.reg1.get())
                    print("self.reg2: ",self.reg2.get())
                    print("self.reg3: ",self.reg3.get())
                    print("self.reg4: ",self.reg4.get())
                    print("self.reg5: ",self.reg5.get())
                    print("self.reg6: ",self.reg6.get())
                    print("self.reg7: ",self.reg7.get())
                    print("self.reg8: ",self.reg8.get())
                    print("self.reg9: ",self.reg9.get())
                    print("self.reg10: ",self.reg10.get())
                    
                    # values = [ int(self.reg1.get(),16),int(self.reg2.get(),16), int(self.reg3.get(),16), int(self.reg4.get(),16), int(self.reg5.get(),16), int(self.reg6.get(),16), int(self.reg7.get(),16), int(self.reg8.get(),16), int(self.reg9.get(),16), int(self.reg10.get(),16)]
                    # print(values)
                    print(type(self.reg1))
                    if  self.reg2.get() == "01":
                        self.variable11.set(f"{round((247 *(int(self.reg3.get()  ,16)*(1.966953395*1e-7))) - (242*x1),4)} °C" )
                        
                        self.variable12.set(f"{round((247 *(int(self.reg4.get()  ,16)*(1.966953395*1e-7))) - (242*x2),4)} °C" )

                        self.variable13.set(f"{round((247 *(int(self.reg5.get()  ,16)*(1.966953395*1e-7))) - (242*x3),4)} °C" )

                        self.variable14.set(f"{round((247 *(int(self.reg6.get()  ,16)*(1.966953395*1e-7))) - (242*x4),4)} °C" )

                        self.variable15.set(f"{round((247 *(int(self.reg7.get()  ,16)*(1.966953395*1e-7))) - (242*x5),4)} °C" )

                        self.variable16.set(f"{round((247 *(int(self.reg8.get() ,16)*(1.966953395*1e-7))) - (242*x6),4)} °C" )

                        self.variable17.set(f"{round((247 *(int(self.reg9.get() ,16)*(1.966953395*1e-7))) - (242*x7),4)} °C" )

                        self.variable18.set(f"{round((247 *(int(self.reg10.get() ,16)*(1.966953395*1e-7))) - (242*x8),4)} °C" )
                    elif  self.reg2.get()=="02":
                        self.variable21.set(f"{round((247 *(int(self.reg3.get() ,16)*(1.966953395*1e-7))) - (242*x1),4)} °C" )
                        
                        self.variable22.set(f"{round((247 *(int(self.reg4.get()  ,16)*(1.966953395*1e-7))) - (242*x2),4)} °C" )
                        
                        self.variable23.set(f"{round((247 *(int(self.reg5.get()  ,16)*(1.966953395*1e-7))) - (242*x3),4)} °C" )

                        self.variable24.set(f"{round((247 *(int(self.reg6.get()  ,16)*(1.966953395*1e-7))) - (242*x4),4)} °C" )

                        self.variable25.set(f"{round((247 *(int(self.reg7.get()  ,16)*(1.966953395*1e-7))) - (242*x5),4)} °C" )

                        self.variable26.set(f"{round((247 *(int(self.reg8.get()  ,16)*(1.966953395*1e-7))) - (242*x6),4)} °C" )

                        self.variable27.set(f"{round((247 *(int(self.reg9.get() ,16)*(1.966953395*1e-7))) - (242*x7),4)} °C" )

                        self.variable28.set(f"{round((247 *(int(self.reg10.get() ,16)*(1.966953395*1e-7))) - (242*x8),4)} °C" )
                    elif  self.reg2.get()=="03":
                        self.variable31.set(f"{round((247 *(int(self.reg3.get()  ,16)*(1.966953395*1e-7))) - (242*x1),4)} °C" )
                        
                        self.variable32.set(f"{round((247 *(int(self.reg4.get()  ,16)*(1.966953395*1e-7))) - (242*x2),4)} °C" )
                        
                        self.variable33.set(f"{round((247 *(int(self.reg5.get()  ,16)*(1.966953395*1e-7))) - (242*x3),4)} °C" )

                        self.variable34.set(f"{round((247 *(int(self.reg6.get()  ,16)*(1.966953395*1e-7))) - (242*x4),4)} °C" )

                        self.variable35.set(f"{round((247 *(int(self.reg7.get()  ,16)*(1.966953395*1e-7))) - (242*x5),4)} °C" )

                        self.variable36.set(f"{round((247 *(int(self.reg8.get()  ,16)*(1.966953395*1e-7))) - (242*x6),4)} °C" )

                        self.variable37.set(f"{round((247 *(int(self.reg9.get() ,16)*(1.966953395*1e-7))) - (242*x7),4)} °C" )

                        self.variable38.set(f"{round((247 *(int(self.reg10.get() ,16)*(1.966953395*1e-7))) - (242*x8),4)} °C" )
                    elif  self.reg2.get()=="04":
                        self.variable41.set(f"{round((247 *(int(self.reg3.get()  ,16)*(1.966953395*1e-7))) - (242*x1),4)} °C" )
                        
                        self.variable42.set(f"{round((247 *(int(self.reg4.get()  ,16)*(1.966953395*1e-7))) - (242*x2),4)} °C" )
                        
                        self.variable43.set(f"{round((247 *(int(self.reg5.get()  ,16)*(1.966953395*1e-7))) - (242*x3),4)} °C" )

                        self.variable44.set(f"{round((247 *(int(self.reg6.get()  ,16)*(1.966953395*1e-7))) - (242*x4),4)} °C" )

                        self.variable45.set(f"{round((247 *(int(self.reg7.get()  ,16)*(1.966953395*1e-7))) - (242*x5),4)} °C" )

                        self.variable46.set(f"{round((247 *(int(self.reg8.get()  ,16)*(1.966953395*1e-7))) - (242*x6),4)} °C" )

                        self.variable47.set(f"{round((247 *(int(self.reg9.get() ,16)*(1.966953395*1e-7))) - (242*x7),4)} °C" )

                        self.variable48.set(f"{round((247 *(int(self.reg10.get() ,16)*(1.966953395*1e-7))) - (242*x8),4)} °C" )
                    elif  self.reg2.get()=="05":
                        self.variable51.set(f"{round((247 *(int(self.reg3.get()  ,16)*(1.966953395*1e-7))) - (242*x1),4)} °C" )
                        
                        self.variable52.set(f"{round((247 *(int(self.reg4.get()  ,16)*(1.966953395*1e-7))) - (242*x2),4)} °C" )
                        
                        self.variable53.set(f"{round((247 *(int(self.reg5.get()  ,16)*(1.966953395*1e-7))) - (242*x3),4)} °C" )

                        self.variable54.set(f"{round((247 *(int(self.reg6.get()  ,16)*(1.966953395*1e-7))) - (242*x4),4)} °C" )

                        self.variable55.set(f"{round((247 *(int(self.reg7.get()  ,16)*(1.966953395*1e-7))) - (242*x5),4)} °C" )

                        self.variable56.set(f"{round((247 *(int(self.reg8.get()  ,16)*(1.966953395*1e-7))) - (242*x6),4)} °C" )

                        self.variable57.set(f"{round((247 *(int(self.reg9.get() ,16)*(1.966953395*1e-7))) - (242*x7),4)} °C" )

                        self.variable58.set(f"{round((247 *(int(self.reg10.get() ,16)*(1.966953395*1e-7))) - (242*x8),4)} °C" )
                    else:
    ...
    def create_widgets(self):
        ...
        self.text12 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text14 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text14.place(x=250, y=340)

        self.text15 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text17 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text17.place(x=250, y=580)

        self.text18 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text22 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text24 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text24.place(x=500, y=340)

        self.text25 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text27 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text27.place(x=500, y=580)

        self.text28 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text32 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text34 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text34.place(x=750, y=340)

        self.text35 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text37 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text37.place(x=750, y=580)

        self.text38 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text42 = tk.Label(self.root, height=2, width=20,text = "NC",font =self.font2)
        ...
        self.text44 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text44.place(x=1000, y=340)

        self.text45 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        ...
        self.text47 = tk.Label(self.root, height=2, width=20, text = "NC",font =self.font2)
        self.text47.place(x=1000, y=580)

        self.text48 = tk.Label(self.root, height=2, width=20,text = "NC",font =self.font2)
        ...
        self.root.after(1000, self.create_widgets)  
